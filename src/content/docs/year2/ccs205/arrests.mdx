...
#### Irregularity and defects of a warrant

>*An irregularity or defect in the substance or form of a warrant, and any variance
between it and the written complaint or information, or between either and the 
evidence produced on part of the prosecution at a trial, shall not affect the 
validity of any proceedings at or subsequent to the hearing of the case, but, if
a variance appears to the court to be such that the accused has been thereby deceived
or mislead, the court may, at the request of the accused, adjourn the hearing of 
the case to some future date, and in the meantime remand the accused or admit him
to bail.*

<Source 
  name="Criminal Procedure Code: Section 113"
  href="https://www.kenyalaw.org/lex/actview.xql?actid=CAP.%2075#sec_113"
  type="ref"
/>

This means that, if there is a small error in the warrant, like a typo, slightly
wrong address or the warrant doesn't perfectly match the formal charges or the 
charges don't align with the evidence the prosecution presents in court, these
minor mistakes won't cause the court to automatically throw out the case.

**Exception:**
However, if the mistake is significant that it acutally confused or harmed the 
accused's ability to defend themselves, the court, at the request of the accused will,
- delay the trial (adjourn the hearing)
- keep the accused in jail(remand) or release them on bail until the new trial date.
