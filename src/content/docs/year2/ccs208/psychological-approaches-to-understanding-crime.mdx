...
Affect and cognition are two interconnected aspects of the human mind, where
emotions (affect) can influence thinking (cognition) and vice versa.

Affections such as happiness or sadness can impact cognition processes such as 
memory, judgement and decision-making. Conversly, our thoughts and interpretation
can invoke emotions.

###### 1. The influence of affect on cognition

- **Mood:** Our mood can affect our reactions to new stimuli. For example, if we meet
new people and we are in a good mood, chances are we will like them.
- **Memory:** Mood congruence effects refers to our tendancy to remember positive
information when we are in a good mood. For example Happy moods might enhance 
memory for pleasent events, while sad moods might make it easier to remember 
unpleasent ones.
- **Information Processing:** Affect can influence the strategies we use to process
information. For instance, negative affect might encourage us to think more
carefully and thoroughly, reducing errors in judgement.

###### 2. The influence of cognition on affect

- Cognition can influence emotions through the activation of schemas which contain
a strong affective component, for example, a negative sterotype might affect
current feelings.
