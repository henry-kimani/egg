...
import { Aside } from "@astro/starlight/components";
...
The correlation between to concepts can either be:
1. None: no correlation
2. Positive: Where an increase in one results in an increase in another
3. Decrease: Where one decreases, another decreases too.
4. Negative: Where increase in one, decreases the other or vice versa.
